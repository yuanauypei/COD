...
from Src.utils.Dataloader0227 import CamObjDataset
...
def parse():
    ...
    parser.add_argument('--save_model', type=str, default='./Snapshot/2020-CVPR-SINet-0228-02/')
...
def main():
    ...
    for epoch_iter in range(1, opt.epoch):
        ...
        trainer(train_loader=train_loader, model=net,
                ...
                opt=opt, loss_func=CEL, total_step=total_step, device=device)
