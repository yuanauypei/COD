...
'''
每次运行 需要修改model_path / test_save / text_save / text_name 等参数
'''

parser = argparse.ArgumentParser()
parser.add_argument('--testsize', type=int, default=352, help='the snapshot input size')
parser.add_argument('--model_path', type=str,
                    default='./Snapshot/2020-CVPR-SINet-0228-01/SINet_80.pth')
parser.add_argument('--test_save', type=str,
                    default='./Result/2020-CVPR-SINet-0228-01/')
parser.add_argument('--text_save', type=str,
                default='./Result/log/2020-CVPR-SINet-0228-01/')                
...
dict_new = {}
for name in dict:
    if 'bn.num_batches_tracked' in name:
        pass
    else:
        new_name = name.split('module.')[-1]
        dict_new[new_name] = dict[name]
