...
from Src.utils.Dataloader0224 import CamObjDataset
...
def parse():
    ...
    parser.add_argument('--lr', type=float, default=3e-4,
                        help='init learning rate, try lr=3e-4')
    ...
    parser.add_argument('--decay_rate', type=float, default=1-4e-2,
    ...
    parser.add_argument('--save_model', type=str, default='./Snapshot/2020-CVPR-SINet-0224/')
    ...
    for epoch_iter in range(1, opt.epoch):
        ...
        if epoch_iter <= 100:
            trainer(train_loader=train_loader, model=net,
                    ...
                    opt=opt, loss_func=MSE, total_step=total_step, device=device)
        elif epoch_iter > 100:
            trainer(train_loader=train_loader, model=net,
                    optimizer=optimizer, epoch=epoch_iter,
