...
def Evaluator(
    test_root='/media/disk1/zhuyuan/datasets/CamouflagedObjectDetection/TestDataset/', 
    snap_path='./ERRNet_Snapshot.pth', 
    save_path='./result/',
    trainsize=352):
    ...
    for _data in ['CAMO_TestingDataset']:
        
        test_data_root = os.path.join(test_root, _data)
        test_dataloader = test_dataset(image_root=test_data_root + '/Image/', gt_root=test_data_root + '/GT/', testsize=trainsize)
