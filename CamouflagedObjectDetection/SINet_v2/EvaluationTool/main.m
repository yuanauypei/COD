...
Models = {'2020-CVPR-SINet2'};   % You can add other model like this format: Models = {'2019-ICCV-EGNet','2019-CVPR-CPD'};
modelNum = length(Models);

% ---- 2. Ground-truth Datasets Setting ----
DataPath = '/media/disk1/zhuyuan/datasets/CamouflagedObjectDetection/TestDataset/';
Datasets = {'CHAMELEON_TestingDataset', 'CAMO_TestingDataset','COD10K_TestingDataset'};  % You may also need other datasets, such as Datasets = {'CAMO','CPD1K'};
