...
parser.add_argument('--train_image_root', default="/media/disk1/zhuyuan/datasets/CamouflagedObjectDetection/COD10K_CAMO_CombinedTrainingDataset/Image/",
                    help='training image root directory')
parser.add_argument('--train_gt_root', default="/media/disk1/zhuyuan/datasets/CamouflagedObjectDetection/COD10K_CAMO_CombinedTrainingDataset/GT/",
