...
from lib.Network_Res2Net_GRA_NCD_ori import Network
...
def train(train_loader, model, optimizer, epoch, save_path, writer, loss_func):
    """
    train function
    """
    global step
    ...
    try:
        for i, (images, gts) in enumerate(train_loader, start=1):
            ...
            #new
            loss_init = loss_func(preds[0], gts) + loss_func(preds[1], gts) + loss_func(preds[2], gts)
            loss_final = loss_func(preds[3], gts)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--batchsize', type=int, default=16, help='training batch size')   #ori  36
    ...
    parser.add_argument('--train_root', type=str, default="/media/disk1/zhuyuan/datasets/CamouflagedObjectDetection/COD10K_CAMO_CombinedTrainingDataset/",
                        help='the training rgb images root')
    parser.add_argument('--val_root', type=str, default="/media/disk1/zhuyuan/datasets/CamouflagedObjectDetection/TestDataset/COD10K_TestingDataset/",
                        help='the test rgb images root')
    parser.add_argument('--save_path', type=str,
                        default='./snapshot/SINet_V2_loss_CEL_ori',
    ...
    for epoch in range(1, opt.epoch):
        ...
        train(train_loader, model, optimizer, epoch, save_path, writer,loss_func=CEL)
